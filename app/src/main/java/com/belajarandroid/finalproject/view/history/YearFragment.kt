...
class YearFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getHistory(auth, userId.toString(), Constant.YEAR)
    ...
    private fun initLiveData() {
        ...
        viewModel.dataHistory.observe(requireActivity()) {
            ...
            rvYearHistory.adapter = AdapterLocationHistory(pagerList)
            rvYearHistory.layoutManager = LinearLayoutManager(requireContext(),
