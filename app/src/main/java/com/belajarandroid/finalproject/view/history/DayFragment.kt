...
import com.belajarandroid.finalproject.databinding.FragmentDayBinding
...
class DayFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getHistory(auth, userId.toString(),Constant.DAY)
    ...
    private fun initLiveData() {
        ...
        viewModel.dataHistory.observe(requireActivity()) {
            ...
            rvDayHistory.adapter = AdapterLocationHistory(pagerList)
            rvDayHistory.layoutManager = LinearLayoutManager(requireContext(),
