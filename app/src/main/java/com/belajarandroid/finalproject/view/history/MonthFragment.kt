...
import com.belajarandroid.finalproject.databinding.FragmentMonthBinding
...
class MonthFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getHistory(auth, userId.toString(), Constant.MONTH)
    ...
    private fun initLiveData() {
        ...
        viewModel.dataHistory.observe(requireActivity()) {
            ...
            rvMonthHistory.adapter = AdapterLocationHistory(pagerList)
            rvMonthHistory.layoutManager = LinearLayoutManager(requireContext(),
